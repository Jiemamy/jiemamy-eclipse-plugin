...
public class ConstraintTreeEditPart extends AbstractModelTreeEditPart {
	 ...
	 */
	public ConstraintTreeEditPart(ConstraintModel attributeModel) {
	...
	public ConstraintModel getModel() {
		return (ConstraintModel) super.getModel();
	}
	
	public JiemamyEntity getTargetModel() {
		ConstraintModel model = getModel();
		return model;
	}
	
	@Override
	public void setModel(Object model) {
		if (model instanceof ConstraintModel) {
